...
void main() {
  group('Serialization Tests', () {
    test('MacmahonPlayer serialization', () {
      ...
      player.addOpponent('2');
      player.floatHistory.add(1);

      final json = player.toJson();
      final restored = MacmahonPlayer.fromJson(json);
    ...
    test('PairingResult serialization', () {
      final p1 = MacmahonPlayer(id: '1', name: 'P1', initialMms: 10.0, currentMms: 10.0);
      final p2 = MacmahonPlayer(id: '2', name: 'P2', initialMms: 10.0, currentMms: 10.0);
      final players = [p1, p2];

      final pair = MacmahonPair(black: p1, white: p2, cost: 0.0);
      final result = PairingResult(round: 1, pairs: [pair]);

      final json = result.toJson();
      final restored = PairingResult.fromJson(json, players);
